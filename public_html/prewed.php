                ...
                <div class="content-holder ch-fw vis-dec-anim">
                                ...
                                <div class="swiper-container">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide hov_zoom">
                                            <img  src="images/2 prewedding/1.jpg"   alt="">
                                            <a href="images/2 prewedding/1.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                                        </div>
                                        <!-- swiper-slide end-->  
                                        <!-- swiper-slide-->  
                                        <div class="swiper-slide hov_zoom">
                                            <img  src="images/2 prewedding/2.jpg"   alt="">
                                            <a href="images/2 prewedding/2.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                                        </div>
                                        <!-- swiper-slide end-->                                      
                                        <!-- swiper-slide-->  
                                        <div class="swiper-slide hov_zoom">
                                            <img  src="images/2 prewedding/3.jpg"   alt="">
                                            <a href="images/2 prewedding/3.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                                        </div>
                                        <!-- swiper-slide end--> 
                                        <!-- swiper-slide-->  
                                        <div class="swiper-slide hov_zoom">
                                            <img  src="images/2 prewedding/4.jpg"   alt="">
                                            <a href="images/2 prewedding/4.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                                        </div>
                                        <!-- swiper-slide end--> 
                                        <!-- swiper-slide-->  
                                        <div class="swiper-slide hov_zoom">
                                            <img  src="images/2 prewedding/5.jpg"   alt="">
                                            <a href="images/2 prewedding/5.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                                        </div>
                                        <!-- swiper-slide end--> 
                        ...
                        <section class="single-content-section" id="secdet">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <h4 class="bold-text">What is the point of pre wedding shoot?  </h4>
                                        <p>Pre-wedding shoots are for those who want good pictures of togetherness; without the hassles of the heavy wedding attires, makeup, ornaments, umpteen number of people around, and the annoying selfies. Pre-wedding photography allows both partners to get to know each other better. You are free to pose or not to pose. </p>
                                        <p>Pre-wedding shoot photographers are intent on capturing natural moments, expressions, and real emotions shared by the couple. Such pictures make your album more vibrant. </p>
										<p>Print your pre-wedding photos, in your wedding invitation card, or play them as a slideshow at the wedding reception, Sangeet or the special Sufi Night. Let your guests enjoy the slideshow at dinner time, or while they mingle with relatives and friends. These photos will brighten up the evening, spread laughter and joy in the wedding. Your pre-wedding photos can be the best storyteller- narrating your love story in a splendid manner.</p>
										<p>Pre-wedding photoshoot provides a number of stunning images. You can use them as a wall-decors in your room. They will stand out among the rest of your usual wedding pictures. If you want to go for a pre-wedding shoot research on ideas like choosing a location, a specific theme, classy props, etc. so that your pre-wedding photos will look epic. We have listed out a few reasons why you should go for a pre-wedding photo shoot.</p>
										
                                        <a href="contacts.php" class="ajax single-btn fl-wrap"><span>Start a Project</span></a>				
                                    </div>
                                    <div class="col-md-1"></div>
                                    <div class="col-md-2">
                    ...
                    <div class="content-nav_holder fl-wrap sec-anim">
                        <div class="content-nav">
                            <ul>
                                <li>
                                    <a href="kidsshoot.php" class="ln ajax"><i class="fal fa-long-arrow-left"></i><span>Prev -<strong> Forever Young</strong></span></a>
                                    <div class="content-nav-media">
                                        <div class="bg"  data-bg="images/folio/1.jpg"></div>
                                    </div>
                                </li>
                                <li>
                                    <a href="maternity.php" class="rn ajax"><span >Next -<strong>  My Blooming Backyard</strong></span> <i class="fal fa-long-arrow-right"></i></a>
                                    <div class="content-nav-media">
                                        <div class="bg"  data-bg="images/folio/1.jpg"></div>
                                    </div>
                                </li>
