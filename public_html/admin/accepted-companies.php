...
if(!$isAdmin){
    ...
    if (strpos($userPermissionsList, 'Companies') === false) {
        echo '<script>';
...
?>
    ...
    <div class="pagetitle">
      <h1>Accepted companies</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
          <li class="breadcrumb-item active">Accepted companies</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12 ">
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-6">
                  <h5 class="card-title">Accepted companies</h5>
                </div>
            ...
            <div class="modal-body">
                ...
                <div id="displayCompanyDetailsDiv"></div>
                  <div id="displayCompanyPhotographsDiv"></div>
                   ...
                   <br><hr>
                    <div id="displayCompanyPhotographsListDiv"></div>
                ...
                <div class="row mb-3">
                 ...
                 <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                   ...
                   <div class="row mb-3">
                            <label for="" class="col-12 col-form-label">Assaigned Photographer & Vediographer</label>
                           
                            <div class="col-12">
                                
                                 <select class="form-control select2" aria-label="Default select example" id="selPV" name="selPV" multiple>
                                    </select>
                                
                                
                                
                                <div class="invalid-feedback">
                                Please select the Photographer & Vediographer!.
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                 ...
                                 <label for="" class="col-12 col-form-label text-dark">Service Center Type</label>
                                            ...
                                            <div class="col-12">
                                                 ...
                                                 <input type="text" class="form-control select2" aria-label="Default select example" id="selServiceCenter" name="selServiceCenter" disabled>
                                 ...
                                 <label for="" class="col-12 col-form-label text-dark">Select service center sub cateory</label>
                                            ...
                                            <div class="col-12">
                                                 ...
                                                 <select class="form-control select2" aria-label="Default select example" id="selRating" name="selRating">
                                                     <option value="" selected>Select sub cateory</option>
                                                    </select>
...
var isCityEdt = false;
  ...
  function getAssaignedMachooosPV(selectId,val="") {
    ...
    successFn = function(resp)  {
      ...
      var users = resp["data"];
      var options = "<option selected value=''>Select Assaigned Photographer & Vediographer</option>";
      $.each(users, function(key,value) {
        // console.log(value.id);
        if(val == value.id) options += "<option value='"+value.id+"' selected>"+value.name+" "+value.lastname+"</option>";
        else options += "<option value='"+value.id+"'>"+value.name+" "+value.lastname+"</option>";
    ...
    data = { "function": 'SystemManage',"method": "getAssaignedMachooosPV",'selCity':selCity };
...
function changeStaff(id,user,number,c_is,s_id,d_id,center_name,servicescenter_id,rating_val,photographers){
     ...
     isCityEdt = true;
      ...
      $('#submitLoadingButton1').addClass('d-none');
            ...
            var valuesArray = photographers.split(',').map(Number);
            $("#selPV").val(valuesArray).trigger('change');
            
            
            $("#selServiceCenter").val(center_name);
            
    $("#addUserModal1").modal('show');
    changeServiceCenter(servicescenter_id,rating_val);
    
}

 function changeServiceCenter(selServiceCenter,val=""){
...
function acptRequest(){
  ...
  function getUserListData(){
             ...
             { "data": "center_name" },
              ...
              { "data": "city_id" },
                ...
                {"data":null,"render":function(item){
                  ...
                  str += '<span class="badge bg-primary text-white" onclick="changeStaff('+item.id+',`'+item.machoose_user_id+'`,`'+item.machoose_user_phone+'`,`'+item.staff_county_id+'`,`'+item.staff_state_id+'`,`'+item.staff_city_id+'`,`'+item.center_name+'`,'+item.servicescenter_id+','+item.rating_val+',`'+item.photographers+'`);" style="cursor:pointer">Change staff</span>';
    ...
    data = { "function": 'SystemManage',"method": "getacceptedprovidersUserListData" ,'provider_id':disType };
...
function getAllPhotographsList(ids){
     ...
     successFn = function(resp)  {
            ...
            if(resp.status == 1){
                ...
                if(images.length > 0){
                    ...
                    var disD = '';
                    disD +='<h5 class="card-title">Photographs Details</h5>';
                    
                    for(var i=0;i<images.length;i++){
                        
                        var name = images[i]['name'];
                        var lastname = images[i]['lastname'];
                        var phone = images[i]['phone'];
                        var email = images[i]['email'];
                        
                        
                         disD +='<div class="row"><div class="col-lg-3 col-md-4 label text-muted ">Name</div><div class="col-lg-9 col-md-8">'+name+' '+lastname+'</div></div>';
                        disD +='<br><div class="row"><div class="col-lg-3 col-md-4 label text-muted ">Email</div><div class="col-lg-9 col-md-8">'+email+'</div></div>';
           
                        disD +='<br><div class="row"><div class="col-lg-3 col-md-4 label text-muted ">Contact number</div><div class="col-lg-9 col-md-8">+91 '+phone+'</div></div>';
                    ...
                    var disD = '';
                    disD +='<h5 class="card-title">Photographs Details</h5>';
                    disD +='<p class="text-muted">Photographs not available</p>';
                    
                  
                }
                
                $('#displayCompanyPhotographsListDiv').html(disD);

                
            }
            
        }
        data = { "function": 'SystemManage',"method": "getAllPhotographsList",'selectedIds':ids };
  ...
  function viewDetails(id){
      ...
      $('#displayCompanyPhotographsListDiv').html('');
     ...
     $('#displayCompanyBrucherEditDiv').html('');
      ...
      successFn = function(resp)  {
        ...
        if(resp.status == 1){
            ...
            getAllPhotographsList(resp.data.photographers);
  ...
  function getAllDoc(selectedCompanyId){
    ...
    successFn = function(resp)  {
        ...
        if(resp.status == 1){
            ...
            if(images.length > 0){
                ...
                var disD = '';
                var disD1 = '';
                disD +='<h5 class="card-title">Legal Documents</h5>';
