          ...
          <div class="card">
            <div class="card-body" id="addEventFormDiv">
              ...
              <form id="addCountyForm"  >
                ...
                <div class="row mb-3">
                    <label for="" class="col-12 col-form-label">Enter Event Type</label>
                    <div class="col-12">
                        <input type="text" class="form-control" id="inpEventType" name="inpEventType">
              ...
              <div class="row">
                <div class="col-3">
                 ...
                 <div class="col-3 pt-4">
                    <select class="form-control select2" aria-label="Default select example" id="disType" name="disType" onchange="getState1('disType1');getEVTypeListData();">
                   ...
                   <div class="col-3 pt-4">
                    <select class="form-control select2" aria-label="Default select example" id="disType1" name="disType1" onchange="getEVTypeListData();">
                ...
                <div class="col-3 pt-4 " align="right">
                  <button class="btn btn-primary " onclick="showAddEventTypeSection();">Add New Event Type</button>
                </div>
              </div> 
...
function getState1(selectId) {
  ...
  function getEVTypeListData(){
    ...
    data = { "function": 'SystemManage',"method": "getEVTypeListData","disType":disType,"disType1":disType1 };
       ...
       $("#submitButton").removeClass("d-none");
        ...
        successFn = function(resp)  {
            if(resp.status == 1){
               ...
               $("#inpEventType").val(eventList['name']);
        ...
        data = { "function": 'SystemManage',"method": "geteditEventTypeList" ,"sel_id":id };
  ...
  $("#addCountyForm").submit(function(event) {
    ...
    submitHandler: function(form) {
        ...
        formData.append('method', 'saveEventType');
        ...
        return new swal({
                title: "Are you sure?",
                text: "You want to "+save+" this Event Type",
                icon: false,
                // buttons: true,
                // dangerMode: true,
                            ...
                            success: function(resp){
                                ...
                                if(resp.status == 1){
                                    Swal.fire({
                                        icon: 'success',
                                        // title: resp.data,
                                        title: "Event Type "+save+" successfully",
     ...
     return new swal({
             ...
             confirmButtonText: 'Yes'
                 ...
                 if (confirm.isConfirmed) {
                     ...
                     data = { "function": 'SystemManage',"method": "deleteEvType" ,"sel_id":id };
                     apiCall(data,successFn);
                 }
         });
}
