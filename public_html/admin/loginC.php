...
<div class="container">
    <section class="section d-flex flex-column align-items-center justify-content-center py-4">
        ...
        <div class="container">
            ...
            <div class="row d-flex flex-column align-items-center justify-content-center py-4">
                    ...
                    <div class="card mb-3" id="loginDiv">
                     ...
                     <div class="card mb-3 d-none" id="authDiv">
                       ...
                       <div class="credits pb-4" align="center" style="padding:10px;">
                            ...
                            <a href="service-provider-login.php">I am a service provider in Machooos International</a>
                        </div>
