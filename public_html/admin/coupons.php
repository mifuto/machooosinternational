          ...
          <div class="row">
            <div class="col-md-3">
             ...
             <div class="col-md-3 mt-3">
                <select class="form-control select2" aria-label="Default select example" id="disType" name="disType" onchange="getSubCouponDiscount();">
                            <option value="" selected>All albums</option>
                            <option value="OA">Online albums</option>
                            <option value="SA">Signature albums</option> 
                        </select>
        ...
        <div class="card-body">
          ...
          <form action="" id="frm-subs">
            <div class="row">
              ...
              <div class="col-lg-6">
                <label for="AlbumType" class="col-sm-12 col-form-label">Select album type</label>
                <div class="col-sm-12">
                  <select name="AlbumType" id="AlbumType" class="form-control" onchange="removeErrAlert('AlbumType');">
...
<script>
  ...
  getSubCouponDiscount();
    ...
    $("#submitButton").on('click', function(e){
      ...
      $("#AlbumType").removeClass('is-invalid');
  ...
  function editPlan(id){
      ...
      successFn = function(resp) {
        ...
        $("#AlbumType").val(data[0]['AlbumType']);
                ...
                "columns": [
                 { "data": "id",
                  ...
                  { "data": "AlbumType",
                    ...
                    "render": function ( data, type, full, meta ) {
                        if(data=='OA') return  'Online album';
                        else return  'Signature album';
                    }
                  },
