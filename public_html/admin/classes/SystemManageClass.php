       ...
       $recentActivity = new Dashboard(true);
		...
		if($_REQUEST['hiddenEventId']=='' ){
           ...
           $activityMeg = "State ".$_REQUEST['inpState']." is created by ".$isUsername;
			...
			$result = $this->dbc->InsertUpdate($data, 'tblstate');
	...
	public function savecity(){
       ...
       $recentActivity = new Dashboard(true);
		...
		$recentActivity->addRecentActivity($this->dbc , $activityMeg , "create",$isCounty_id,$isState_id,$isCity_id);
			...
			$result = $this->dbc->InsertUpdate($data, 'tblcity');
    ...
    public function saveRoles(){
       ...
       $recentActivity = new Dashboard(true);
		...
		$recentActivity->addRecentActivity($this->dbc , $activityMeg , "create",$isCounty_id,$isState_id,$isCity_id);
			...
			$result = $this->dbc->InsertUpdate($data, 'tbluserroles');
    ...
    public function saveStaffData(){
       ...
       $recentActivity = new Dashboard(true);
		...
		if($_REQUEST['hiddenEventId']=='' ){
    		...
    		$result = $this->dbc->InsertUpdate($data, 'tblstaffuserlogin');
	...
	public function saveEventType(){
       ...
       $recentActivity = new Dashboard(true);
		...
		$recentActivity->addRecentActivity($this->dbc , $activityMeg , "create",$isCounty_id,$isState_id,$isCity_id);
			...
			$result = $this->dbc->InsertUpdate($data, 'tblcustomers_groups');
	...
	public function saveServiceType(){
       ...
       $recentActivity = new Dashboard(true);
		...
		$recentActivity->addRecentActivity($this->dbc , $activityMeg , "create",$isCounty_id,$isState_id,$isCity_id);
			...
			$result = $this->dbc->InsertUpdate($data, 'tblservice_type');
	...
	public function saveHV(){
       ...
       $recentActivity = new Dashboard(true);
		...
		$recentActivity->addRecentActivity($this->dbc , $activityMeg , "create",$isCounty_id,$isState_id,$isCity_id);
			...
			$result = $this->dbc->InsertUpdate($data, 'tblhome_vedio');
	...
	public function savePopups(){
       ...
       $recentActivity = new Dashboard(true);
		...
		$recentActivity->addRecentActivity($this->dbc , $activityMeg , "create",$isCounty_id,$isState_id,$isCity_id);
			...
			$result = $this->dbc->InsertUpdate($data, 'tblpopups');
	...
	public function saveNews(){
       ...
       $recentActivity = new Dashboard(true);
		...
		$recentActivity->addRecentActivity($this->dbc , $activityMeg , "create",$isCounty_id,$isState_id,$isCity_id);
			...
			$result = $this->dbc->InsertUpdate($data, 'tbl_latest_news');
	...
	public function saveInsentive(){
       ...
       $recentActivity = new Dashboard(true);
		...
		$recentActivity->addRecentActivity($this->dbc , $activityMeg , "create",$isCounty_id,$isState_id,$isCity_id);
			...
			$result = $this->dbc->InsertUpdate($data, 'tblinsentive');
	...
	public function saveInsentiveRoles(){
       ...
       $recentActivity = new Dashboard(true);
		...
		$recentActivity->addRecentActivity($this->dbc , $activityMeg , "create",$isCounty_id,$isState_id,$isCity_id);
			...
			$result = $this->dbc->InsertUpdate($data, 'tblinsentive_roles');
...
// 	  $sql = "SELECT * FROM tblstaffuserlogin where active=0 order by name asc"; 
       ...
       $recentActivity = new Dashboard(true);
		...
		if($_REQUEST['hiddenEventId']=='' ){
           ...
           $activityMeg = "Services Center ".$_REQUEST['inpServicesCenter']." is created by ".$isUsername;
			...
			$result = $this->dbc->InsertUpdate($data, 'tblservicescenter');
	...
	public function getServiceCenterActiveList(){
	    ...
	    $sql = "SELECT a.name,a.id FROM tblstaffuserlogin a
			WHERE a.active=0 ORDER BY a.name DESC";
...
// 	echo $sql;
		...
		public function getAssaignedMachooosPV(){
		    
		    
	    $selCity= $_REQUEST["selCity"];
	  
	        $sql = "SELECT a.name,a.id,a.lastname FROM tblmifutostaffuserlogin a
			WHERE a.user_status=1 ORDER BY a.name DESC";
...
// 	echo $sql;
	...
	public function acceptCompany(){
		...
		$selRating=$_REQUEST["selRating"];
		
		$inpMachooosPersonPhone=$_REQUEST["inpMachooosPersonPhone"];
		$selAssaignedMachooosPerson=$_REQUEST["selAssaignedMachooosPerson"];
		
		$selPV=implode(',', $_REQUEST["selPV"]);
...
// 		$sqlC = "SELECT a.*,b.center_name,c.short_name , d.state,e.city,m.name as staff FROM tblprovideruserlogin a left join tblservicescenter b on a.servicescenter_id = b.id left join tblcountries c on c.country_id = a.county_id left join tblstate d on d.id=a.state_id left join tblcity e on e.id = a.city_id left join tblstaffuserlogin m on m.id=a.machoose_user_id where a.id='$sel_id' "; 
        ...
        $query = "UPDATE `tblproviderusercompany` SET `is_accept_company`=1,`machoose_user_id`='$selAssaignedMachooosPerson',`machoose_user_phone`='$inpMachooosPersonPhone',`staff_state_id`='$selState',`staff_county_id`='$selCounty',`staff_city_id`='$selCity',`rating_val`='$selRating',`photographers`='$selPV' WHERE `id`=$sel_id";
		$result = $this->dbc->update_row($query);
	...
	public function changeProviderStaff(){
        ...
        $query = "UPDATE `tblproviderusercompany` SET `machoose_user_id`='$selAssaignedMachooosPerson',`machoose_user_phone`='$inpMachooosPersonPhone',`staff_state_id`='$selState',`staff_county_id`='$selCounty',`staff_city_id`='$selCity',`rating_val`='$selRating',`photographers`='$selPV' WHERE `id`=$sel_id";
		$result = $this->dbc->update_row($query);
	...
	public function saveProviderService(){
      ...
      $main_service_id = '';
		...
		$recentActivity->addRecentActivity($this->dbc , $activityMeg , "create");
			...
			$result = $this->dbc->InsertUpdateNewReturn($data, 'tblprovider_services');
			$main_service_id = $result;
	 ...
	 public function saveFAQ(){
       ...
       $recentActivity = new Dashboard(true);
		...
		$recentActivity->addRecentActivity($this->dbc , $activityMeg , "create",$isCounty_id,$isState_id,$isCity_id);
			...
			$result = $this->dbc->InsertUpdate($data, 'tblFAQ');
        ...
        $inpfaq = $_REQUEST['inpfaq'];
		if ($inpfaq== "") {
			$sql = "SELECT * FROM tblFAQ WHERE active = 0 ORDER BY id DESC";
		 } else {
	
			$sql = "SELECT * FROM tblFAQ WHERE active = 0 AND newuser = '$inpfaq' ORDER BY id DESC";
		 }
	...
	function getnewuser() {
		...
		$sql = "SELECT * FROM tblnewuser order by newuser asc"; 
	 ...
	 public function saveMITAC(){
       ...
       $recentActivity = new Dashboard(true);
		...
		$recentActivity->addRecentActivity($this->dbc , $activityMeg , "create",$isCounty_id,$isState_id,$isCity_id);
			...
			$result = $this->dbc->InsertUpdate($data, 'tbl_tac');
       ...
       $recentActivity = new Dashboard(true);
		...
		if($_REQUEST['hiddenEventId2']=='' ){
           ...
           $activityMeg = "Services adding type ".$_REQUEST['inpServicesCenter2']." is created by ".$isUsername;
			...
			$result = $this->dbc->InsertUpdate($data, 'tblservicesaddingtype');
       ...
       $recentActivity = new Dashboard(true);
		...
		if($_REQUEST['hiddenEventId']=='' ){
           ...
           $activityMeg = "Attribute ".$_REQUEST['inpServicesCenter']." is created by ".$isUsername;
			...
			$result = $this->dbc->InsertUpdate($data, 'tblservicesattribute');
       ...
       $recentActivity = new Dashboard(true);
		...
		if($_REQUEST['hiddenEventId1']=='' ){
           ...
           $activityMeg = "Attribute feild ".$_REQUEST['inpServicesCenter1']." is created by ".$isUsername;
			...
			$result = $this->dbc->InsertUpdate($data, 'tblservicesattributefeild');
       ...
       $recentActivity = new Dashboard(true);
		...
		if($_REQUEST['hiddenEventId12']=='' ){
           ...
           $activityMeg = "Service center category ".$_REQUEST['inpServicesCenterSubCat']." is created by ".$isUsername;
			...
			$result = $this->dbc->InsertUpdate($data, 'tblservicecentersubcategory');
       ...
       $recentActivity = new Dashboard(true);
		...
		if($_REQUEST['hiddenEventId123']=='' ){
           ...
           $activityMeg = "Link Attribute ".$_REQUEST['inpServicesLinkName']." is created by ".$isUsername;
			...
			$result = $this->dbc->InsertUpdate($data, 'tblservicelinkattributes');
       ...
       $recentActivity = new Dashboard(true);
		...
		if($_REQUEST['hiddenEventId']=='' ){
           ...
           $activityMeg = "Price ".$resultg[0]['link_name']." is created by ".$isUsername;
			...
			$result = $this->dbc->InsertUpdate($data, 'tblservicespricedetails');
	...
	public function getServicesProviderStaffListData(){
	    
	  
	        $sql = "SELECT a.*,b.state,c.city,cu.short_name FROM tblmifutostaffuserlogin a left join tblstate b on a.state_id = b.id left join tblcity c on a.city_id = c.id left join tblcountries cu on cu.country_id = a.county_id WHERE a.active=1 order by a.id desc";
	...
	public function confrimProviderStaff(){
	    
		$sel_id=$_REQUEST["sel_id"];
	
        $query = "UPDATE `tblmifutostaffuserlogin` SET `user_status`='1' WHERE `id`=$sel_id";
		$result = $this->dbc->update_row($query);
	
      
        if($result != "")self::sendResponse("1", "Successfully confrim Staff");
        else self::sendResponse("2", "Failed to confrim Staff");
	
	}
	
	
	 public function saveSCRP(){
        
         
        $data=array();
        $data["num_day"]=$_REQUEST['selNumberOfDay'];
        $data["percentage_val"]=$_REQUEST['selPercentage'];
       ...
       $recentActivity = new Dashboard(true);
		...
		if($_REQUEST['hiddenEventId']=='' ){
           ...
           $activityMeg = "Service Cancellation and Refund policy for ".$_REQUEST['selNumberOfDay']." day is created by ".$isUsername;
    	
    		$recentActivity->addRecentActivity($this->dbc , $activityMeg , "create",$isCounty_id,$isState_id,$isCity_id);
		  
			$result = $this->dbc->InsertUpdate($data, 'tbl_scrp');

		}else{
		    
		     $activityMeg = "Service Cancellation and Refund policy for ".$_REQUEST['selNumberOfDay']." day is updated by ".$isUsername;
    	
    		$recentActivity->addRecentActivity($this->dbc , $activityMeg , "update",$isCounty_id,$isState_id,$isCity_id);
		   
			$data_id=array(); $data_id["id"]=$_REQUEST['hiddenEventId'];
			$result=$this->dbc->update_query($data, 'tbl_scrp', $data_id);
		}
	...
	public function getSCRPListData(){
	    
	   
	        $sql = "SELECT a.* FROM tbl_scrp a WHERE a.active=0 ORDER BY a.num_day ASC";
	...
	public function geteditSCRPList(){
	    
		$sel_id=$_REQUEST["sel_id"];
	
		$sql = "SELECT * FROM tbl_scrp
    WHERE id = $sel_id ";
		...
		public function deleteSCRP(){
	    
		$sel_id=$_REQUEST["sel_id"];
	
        $query = "UPDATE `tbl_scrp` SET `active`='1' WHERE `id`=$sel_id";
		$result = $this->dbc->update_row($query);
	
      
        if($result != "")self::sendResponse("1", "Successfully delete policy");
        else self::sendResponse("2", "Failed to delete policy");
