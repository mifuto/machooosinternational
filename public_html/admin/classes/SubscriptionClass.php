...
// 		die;
       ...
       $isUsername = $_SESSION['Username'];
			...
			$result = $this->dbc->InsertUpdate($data, 'tbl_card_services');
...
// 			$result = $this->dbc->update_row($sql);
       ...
       $isUsername = $_SESSION['Username'];
			...
			$result = $this->dbc->InsertUpdate($data, 'tbl_cards');
	...
	public function saveSubCard(){
       ...
       $recentActivity = new Dashboard(true);
		...
		$recentActivity->addRecentActivity($this->dbc , $activityMeg , "create",$isCounty_id,$isState_id,$isCity_id);
			...
			$result = $this->dbc->InsertUpdate($data, 'tblsubcards');
	...
	public function saveUserCard(){
       ...
       $recentActivity = new Dashboard(true);
		...
		$recentActivity->addRecentActivity($this->dbc , $activityMeg , "create",$isCounty_id,$isState_id,$isCity_id);
			...
			$result = $this->dbc->InsertUpdate($data, 'tbluser_cards');
...
// 		self::sendResponse("1", "Invoice send to mail.");
	...
	public function updateMifutoUserCardServicePayment(){
		...
		$sql = "UPDATE place_order_userservices SET `newpurchaseID` = '$newpurchaseID' , razorpay_payment_id = '$razorpay_payment_id' ,razorpay_payment_status = '$razorpay_payment_status',razorpay_signature='razorpay_signature', completed=1, invoice_snt=0, `IGST`='$IGST', `CGST`='$CGST', `SGST`='$SGST',`otp`='$otp',`photographerID`='$photographerID'  WHERE id = $purchaseID ";
		$result = $this->dbc->update_row($sql);
...
// 		echo $sql1;
	...
	public function saveUserCardService(){
       ...
       $isUsername = $_SESSION['Username'];
			...
			$result = $this->dbc->InsertUpdate($data, 'tbl_usercard_services');
