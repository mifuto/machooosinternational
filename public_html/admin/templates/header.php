        ...
        <li class="nav-item">
         ...
         <?php if (in_array('Provider-management', explode(',', $userPermissions))) { ?>
          ...
          <?php } ?>
           ...
           <?php if (in_array('Add-one', explode(',', $userPermissions))) { ?>
         
         <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#addone-nav" data-bs-toggle="collapse" href="#">
              <i class="bi bi-node-plus-fill"></i><span>Add one</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="addone-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                
                
                <li>
                    <a href="service-cancellation-refund-policy.php">
                      <i class="bi bi-circle"></i><span>Manage Cancellation  & Refund policy</span>
