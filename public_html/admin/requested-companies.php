...
?>
    ...
    <div class="pagetitle">
      <h1>Newly requested companies</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
          <li class="breadcrumb-item active">Newly requested companies</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12 ">
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-6">
                  <h5 class="card-title">Newly requested companies</h5>
                </div>
...
function acceptCompany(id,center_name,servicescenter_id){
    rejectId = id;
    ...
    changeServiceCenter(servicescenter_id);
...
function acptRequest(){
  ...
  function getUserListData(){
              ...
              { "data": "city_id" },
                ...
                {"data":null,"render":function(item){
                  ...
                  if( item.is_company_add == 1 && item.is_accept_company == 0 && item.is_propert_instructions_add == 1 && item.is_account_add == 1 ){
                      str += '<span class="badge bg-success text-white" onclick="acceptCompany('+item.id+',`'+item.center_name+'`,'+item.servicescenter_id+');" style="cursor:pointer">Accept company</span>';
                  }
    ...
    data = { "function": 'SystemManage',"method": "getrequestedprovidersUserListData" ,'provider_id':disType };
     ...
     $('#displayCompanyBrucherEditDiv').html('');
      ...
      successFn = function(resp)  {
        ...
        if(resp.status == 1){
            ...
            // disD +='<br><div class="row"><div class="col-lg-3 col-md-4 label text-muted ">Assaigned machooos person</div><div class="col-lg-9 col-md-8">'+resp.data.staff+' '+resp.data.staff_lastname+'</div></div>';
