...
?>
    ...
    <section class="section d-none" id="CityFormSection">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body" id="addEventFormDiv">
              ...
              <form id="addCountyForm"  >
                ...
                <div class="row mb-3">
                 ...
                 <div class="row mb-3">
                    ...
                    <div class="col-12">
                         ...
                         <select class="form-control select2" aria-label="Default select example" id="selState" name="selState">
                            </select>
                ...
                <div class="row mb-3">
                    <label for="" class="col-12 col-form-label">Enter District</label>
                    <div class="col-12">
                        <input type="text" class="form-control" id="inpCity" name="inpCity">
                 ...
                 <div class="row mb-3">
                    ...
                    <div class="col-12">
                        <textarea class="form-control" style="height: 100px" id="inpAddress" name="inpAddress"></textarea>
              ...
              <div class="row">
                <div class="col-3">
                 ...
                 <div class="col-3 pt-4">
                    <select class="form-control select2" aria-label="Default select example" id="disType" name="disType" onchange="getState1('disType1');getCityListData();">
                   ...
                   <div class="col-3 pt-4">
                    <select class="form-control select2" aria-label="Default select example" id="disType1" name="disType1" onchange="getCityListData();">
                ...
                <div class="col-3 pt-4 " align="right">
                  <button class="btn btn-primary " onclick="showAddCitySection();">Add New District</button>
                </div>
              </div> 
...
function getState1(selectId) {
  ...
  function showAddCitySection(){
    ...
    $("#CityListSection").addClass("d-none");
        $('#addEVT').html('Add District');
        
       
        $('#CityFormSection').removeClass("d-none");
  ...
  function getCityListData(){
        ...
        $('#eventListTable').DataTable({
            ...
            "columns": [
              ...
              {"data":null,"render":function(item){
                  var str = '<span class="badge bg-info text-dark" onclick="editcityList('+item.id+');" style="cursor:pointer">edit</span><span class="badge bg-danger" onclick="deleteCity('+item.id+');" style="cursor:pointer">delete</span>';
    ...
    data = { "function": 'SystemManage',"method": "getCityListData","disType":disType,"disType1":disType1 };
       ...
       $("#submitButton").removeClass("d-none");
        ...
        successFn = function(resp)  {
            if(resp.status == 1){
               ...
               $("#inpCity").val(eventList['city']);
               $("#inpAddress").val(eventList['address']);
        ...
        data = { "function": 'SystemManage',"method": "geteditcityList" ,"sel_id":id };
  ...
  function cancelCountyForm(){
      emptyForm();
      $('#CityFormSection').addClass("d-none");
      $("#CityListSection").removeClass("d-none");
  }
  ...
  $("#addCountyForm").submit(function(event) {
    ...
    submitHandler: function(form) {
        ...
        formData.append('method', 'savecity');
        
      
       
        return new swal({
                title: "Are you sure?",
                text: "You want to "+save+" this District",
                icon: false,
                // buttons: true,
                // dangerMode: true,
                            ...
                            success: function(resp){
                                ...
                                if(resp.status == 1){
                                    Swal.fire({
                                        icon: 'success',
                                        // title: resp.data,
                                        title: "District "+save+" successfully",
     ...
     return new swal({
             ...
             confirmButtonText: 'Yes'
                 ...
                 if (confirm.isConfirmed) {
                     ...
                     data = { "function": 'SystemManage',"method": "deleteCity" ,"sel_id":id };
                     apiCall(data,successFn);
                 }
         });
}
