              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">For website Admin Activities</p>
                  </div>
                  ...
                  <form id="loginForm" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="invalid-feedback" id="loginFailedErr" >Incorrect username or password. Please re-enter</div>
                    <!-- <div class="col-12">
