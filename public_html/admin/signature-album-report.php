...
var priceExpDate = '';
  ...
  function downloadMailPhone(){
      ...
      var columnData = dataTable.column(1).data().toArray();
        ...
        data = { "function": 'SignatureAlbum',"method": "DwdSAlbumExcelList" ,'data':mailArr};
    ...
    downloadLink.download = 'signature-album-user-info.txt';
               ...
               { "data": "event_name" },
                 { "data": null,
                        render: function ( data ) {
                           ...
                           return '<a class="text-primary"  style="cursor:pointer" onclick="showPrice(`'+imageCount+'`,`'+expiry_date+'`);">View</a>';
  ...
  function showPrice(imageCount,expiry_date){
      priceImageCount = imageCount;
  ...
  function getPriceDetails(){
      var selYear = $('#selYear').val();
        var $imageCount = priceImageCount;
        var photo_count = '';
        if($imageCount > 4999) photo_count='Unlimited';
        else if($imageCount > 2999) photo_count=4999 ;
        else if($imageCount > 1499) photo_count=2999 ;
        else photo_count=1499 ;
        ...
        data = { "function": 'SignatureAlbum',"method": "getPriceDetails" ,"selYear":selYear ,"photo_count":photo_count };
