        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div  style="display:none;" class="form-group register-website-group">
                    ...
                    <div class="form-group register-position-group d-none">
                    ...
                    <div   style="display:none;" class="form-group register-company-phone-group">
                ...
                <div class="col-md-6">
                    <h4   style="opacity:0;" class="bold register-company-info-heading"><?php echo _l('client_register_company_info'); ?></h4>
                    <div style="display:none;" class="form-group mtop15 register-company-group">
                    ...
                    <div  style="display:none;" class="form-group register-vat-group">
                    ...
                    <div class="form-group register-country-group">
                        <label class="control-label" for="lastname"><span class="text-danger">* </span><?php echo _l('clients_country'); ?></label>
                        <select data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" data-live-search="true" name="country" class="form-control" id="country" onchange="changeCountry();">
                            <option value=""></option>
                    ...
                    <div class="form-group register-state-group">
                        <label class="control-label" for="state"><span class="text-danger">* </span><?php echo _l('clients_state'); ?></label>
                        <select data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" data-live-search="true" name="state" class="form-control" id="state" value="<?php echo set_value('state'); ?>" onchange="changeState();">
                        </select>
                        <p class="text-danger alert-validation d-none" id="errState">The State field is required.</p>
                    </div>
                    ...
                    <div class="form-group register-city-group">
                        <!--<label class="control-label" for="city"><span class="text-danger">*</span> <?php echo _l('clients_city'); ?></label>-->
                        <label class="control-label" for="city"><span class="text-danger">*</span> District</label>
                        <select data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" data-live-search="true" name="city" class="form-control" id="city" value="<?php echo set_value('city'); ?>">
                        </select>
                        <p class="text-danger alert-validation d-none" id="errCity">The District field is required.</p>
                    </div>
