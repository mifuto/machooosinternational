 ...
 */
$route['clients/reset_password']  = 'authentication/reset_password/api';
$route['clients/reset_password']  = 'authentication/reset_password';
$route['clients/forgot_password'] = 'authentication/forgot_password/api';
$route['clients/forgot_password'] = 'authentication/forgot_password';
$route['clients/logout']          = 'authentication/logout';
$route['clients/logout']          = 'authentication/logout/api';
$route['clients/register']        = 'authentication/register/api';
$route['clients/register']        = 'authentication/register';
$route['clients/login']        = 'authentication/login/api';
$route['clients/login']           = 'authentication/login';

$route['clients/get_login_session'] = 'clients/get_login_session';

// Aliases for short routes
$route['reset_password']  = 'authentication/reset_password/api';
$route['reset_password']  = 'authentication/reset_password';
$route['forgot_password'] = 'authentication/forgot_password/api';
$route['forgot_password'] = 'authentication/forgot_password';
$route['login']           = 'authentication/login/api';
$route['login']           = 'authentication/login';
$route['logout']          = 'authentication/logout/api';
$route['logout']          = 'authentication/logout';
$route['register']        = 'authentication/register/api';
