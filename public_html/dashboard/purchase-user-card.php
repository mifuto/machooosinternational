...
$sql1 = "SELECT a.*,c.short_name FROM mifuto_users a left join place_order_usercard b on a.id = b.user_id LEFT JOIN tblcountries c on a.country = c.country_id WHERE b.id='$purchaseID' ";
...
if($Cunt <= 0){
    ...
    window.location.href = 'https://mifuto.com/mi-cards.php';
</script>";
...
?>
 ...
 <script>
    ...
    function updatePayment(razorpay_payment_id,razorpay_payment_status,razorpay_signature){
        ...
        var postData = {
            function: 'AlbumSubscription',
            method: "updateMifutoUserCardPayment",
