                    ...
                    <div class="card-deck" >
                            <div class="card col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-4" style="min-height:295px;">
                              <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 d-flex align-items-left justify-items-left ">
                                        <button class="btn btn-success text-white" style="width: 100%;" onclick="payNow();" >Pay ₹<span id="totalDisAmt1"><?= intval($row4['numberOfItemsTotalAmount'])+intval($row4['final_extra_price']) ?></span></button>
