...
$result2 = $DBC->query($sql2);
 $count2 = mysqli_num_rows($result2);
  ...
  $sql4 = "SELECT * FROM place_order_userservices WHERE id='$purchaseID' AND service_status=2 "; 
...
if($Cunt <= 0){
    ...
    window.location.href = 'https://mifuto.com/staff/bookings.php';
</script>";
                            ...
                            <div class="card col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-4" style="min-height:295px;">
                              <div class="card-body">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="row ">
                                        <div class="col-6 d-flex align-items-left justify-items-left ">
                                            <p class="text-dark">
                                                <b>Total Booking Amount </b> (*GST Inclusive)
                                        ...
                                        <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                            <p class="text-dark " id="totalDisAmt"><b>₹<?=number_format($row4['inpTotalCost'], 2);?></b></p>
                                ...
                                <div style="padding-left:20px;">
                                    ...
                                    <?php if($row4['isSte'] == 1){ ?>
                                     ...
                                     <div class="row ">
                                            ...
                                            <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                                <p class="text-dark " id="totalDisTaxablevalue1"><b>₹<?=number_format($row4['inpTotalCost'], 2);?></b></p>
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                                <p class="text-dark "><b id="disCGST"> ₹<?=number_format($row4['CGST'], 2);?></b></p>
                                         ...
                                         <div class="row ">
                                            ...
                                            <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                                <p class="text-dark "><b id="disSGST"> ₹<?=number_format($row4['SGST'], 2);?></b></p>
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                                <p class="text-dark " id="totalDisAmt3"><b>₹<?=number_format($row4['inpTotalCost'], 2);?></b></p>
                                    ...
                                    <?php }else{ ?>
                                     ...
                                     <div class="row ">
                                            ...
                                            <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                                <p class="text-dark " id="totalDisTaxablevalue2"><b>₹<?=number_format($row4['inpTotalCost'], 2);?></b></p>
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                                <p class="text-dark "><b id="disIGST"> ₹<?=number_format($row4['IGST'], 2);?></b></p>
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                                <p class="text-dark " id="totalDisAmt2"><b>₹<?=number_format($row4['inpTotalCost'], 2);?></b></p>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                        <p class="text-success "><b>₹<?=$row4['numberOfItemsTotalAmount'];?></b></p>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                        <p class="text-dark "><b> ₹<?=$row4['extra_photographer_price'];?></b></p>
                                ...
                                <div class="row ">
                                    <div class="col-6 d-flex align-items-left justify-items-left ">
                                        <p class="text-dark">
                                            Extra time vediographer
                                          </p>
                                        
                                    </div>
                                    
                                    <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                        <p class="text-dark "><b> ₹<?=$row4['extra_vediographer_price'];?></b></p>
                                ...
                                <div class="row ">
                                    <div class="col-6 d-flex align-items-left justify-items-left ">
                                        <p class="text-dark">
                                            Extra peoples for service
                                          </p>
                                        
                                    </div>
                                    
                                    <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                        <p class="text-dark "><b> ₹<?=$row4['extraPeoplePrice'];?></b></p>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                        <p class="text-success " id="totalDisAmt"><b>₹<?=$row4['final_extra_price'];?></b></p>
                                ...
                                <div style="padding-left:20px;">
                                    ...
                                    <?php 
                                        ...
                                        $final_extra_price = $row4['final_extra_price'];
                                    ...
                                    if($row4['isSte'] == 1){
                                        ...
                                        $Taxablevalue = number_format( (floatval($final_extra_price) - ( $CGST + $SGST ) ), 2 );
                                    ...
                                    ?>
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                                <p class="text-dark " id="totalDisAmt3"><b>₹<?=$final_extra_price;?></b></p>
                                      ...
                                      $Taxablevalue = number_format( (floatval($final_extra_price) - ( $IGST ) ), 2 );
                                      ...
                                      ?>
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                                <p class="text-dark " id="totalDisAmt2"><b>₹<?=$final_extra_price;?></b></p>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                        <p class="text-dark "><b>₹<?= intval($row4['inpTotalCost'])+intval($row4['final_extra_price']) ?></b></p>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                        <p class="text-danger "><b>- ₹<?=$row4['numberOfItemsTotalAmount'];?></b></p>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                        <p class="text-success "><b>₹<?= intval($row4['numberOfItemsTotalAmount'])+intval($row4['final_extra_price']) ?></b></p>
                                ...
                                <div class="row mb-4">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 d-flex align-items-left justify-items-left ">
                                        <button class="btn btn-success text-white" style="width: 100%;" onclick="payNow();" >Recived ₹<span id="totalDisAmt1"><?= intval($row4['numberOfItemsTotalAmount'])+intval($row4['final_extra_price']) ?> by Cash</span></button>
...
?>
 ...
 <script>
    ...
    function payNow(){
        ...
        var numberOfItemsTotalAmount = '<?=$row4['numberOfItemsTotalAmount']?>';
        var final_extra_price = '<?=$row4['final_extra_price']?>';
        
       
       var amount = parseInt(numberOfItemsTotalAmount) + parseInt(final_extra_price) ;
