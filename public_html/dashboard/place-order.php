...
$timestamp = time();
$setT = 'MI'.$timestamp.'T'.$purchaseID;
...
$result2 = $DBC->query($sql2);
 $count2 = mysqli_num_rows($result2);
  ...
  $sql4 = "SELECT * FROM place_order WHERE id='$purchaseID' AND completed=0 "; 
                              ...
                              <form class="forms-sample" >
                                ...
                                <div class="form-group">
                                  <label for="InputCountry">Select country</label>
                                    ...
                                    <select class="form-control p-input" id="InputCountry">
                            ...
                            <div class="card col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-4" style="min-height:295px;">
                              <div class="card-body">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                        <p class="text-dark "><b>₹<?=$row4['numberOfItemsExtraCharge'];?></b></p>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-6 d-flex align-items-end justify-items-end " style="justify-content: end;">
                                        <p class="text-dark " id="applyCouponPrice"><b>-₹<?=$row4['couponApplyDiscount'];?></b></p>
                                ...
                                <div class="row mb-4">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 d-flex align-items-left justify-items-left ">
                                        <button class="btn btn-success text-white" style="width: 100%;" onclick="payNow();" >Pay Now</button>
        ...
        var postData = {
          ...
          $.ajax({
            ...
            success: function (data) {
                ...
                if (data.status == 1) {
                    window.location.href = 'payment-status.php?purchaseID='+data.data;
