...
$sqlPc = "SELECT a.id,a.numberOfItemsTotalAmount,a.card_number FROM place_order_card a left join tblsubcards b on a.card_id=b.id left join tbl_cards c on b.card_id = c.id WHERE a.razorpay_payment_status=1 AND a.completed=1 AND a.isNew=1 AND a.user_id='$user_id' AND b.state_id='$userState' AND FIND_IN_SET($userCity, b.city_id) AND c.delete=0 ";
                        ...
                        <div class="row">
                                ...
                                <?php
                                    ...
                                    foreach ($Cards as $key => $card) { 
                            		    ...
                            		    $psql = "SELECT * FROM place_order_card WHERE razorpay_payment_status=1 AND completed=1 AND isNew=1 AND card_id='$id' AND user_id='$user_id' ";
                                            ...
                                            <?php if($isPurchaseable > 0){ ?>
                                                    ...
                                                    ?>
                                                            ...
                                                            <?php }else{ ?>
                                                                ...
                                                                <div onclick="showCardDetails(`<?=strtoupper($card['CardName'])?>`,<?=$id?>)" class="card" style="background-image: url('/admin/<?= $card['image'] ?>'); background-size: cover; background-position: center;width: 100% !important;height: 100% !important;" >
                                                                ...
                                                                <?php if($isExp){ ?>
                                                                  ...
                                                                  <!-- Add a centered button -->
                                                                    ...
                                                                    <div style="position: absolute; bottom: 20%; left: 50%; transform: translateX(-50%);">
                                                                        <button class="btn btn-light " style="border-radius: 30%;" onclick="showCardBenfits(`<?=strtoupper($card['CardName'])?>`,<?=$id?>,`<?=$decodeId?>`,1);">activate card</button>
                                                                    </div>
                                                    ...
                                                    <?php }else{ ?>
                                                        ...
                                                        <!-- Add a centered button -->
                                                            ...
                                                            <div style="position: absolute; bottom: 20%; left: 50%; transform: translateX(-50%);">
                                                                <button class="btn btn-dark " style="border-radius: 30%;" onclick="showCardBenfits(`<?=strtoupper($card['CardName'])?>`,<?=$id?>,`<?=$decodeId?>`,2);">upgrade card</button>
                                                            </div>
                                        ...
                                        <?php }else{ ?>
                                             ...
                                             <div class="card" style="background-image: url('/admin/<?= $card['image'] ?>'); background-size: cover; background-position: center;width: 100% !important;height: 100% !important;opacity: .3;">
                                                ...
                                                <!-- Add a centered button -->
                                                    ...
                                                    <div style="position: absolute; bottom: 20%; left: 50%; transform: translateX(-50%);">
                                                        <button class="btn btn-light " style="border-radius: 30%;" onclick="showCardBenfits(`<?=strtoupper($card['CardName'])?>`,<?=$id?>,`<?=$decodeId?>`,0);">view details</button>
                                                    </div>
...
?>
 ...
 <script>
    ...
    function downloadCard(){
        ...
        var activeCardId = '<?=$activeCardId?>';
        var divId = 'card_'+activeCardId;
    ...
    function purchaseNow(){
        ...
        var user_id = '<?=$user_id?>';
        var purchaseCardNumber = '<?=$purchaseCardNumber?>';
    ...
    function showCardDetails(cardName,cardId){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.status == 1) {
                    ...
                    var userPurchasedServices = '<?=$userPurchasedServices?>';
                         
                    getDisplayAllCardServicesForCard(userPurchasedServices,'displayAllCardServices1');
    ...
    function showCardBenfits(cardName,cardId,purchaseId,isUpdate){
            ...
            success: function (data) {
                ...
                if (data.status == 1) {
                    ...
                    if(isUpdate == 2){
                        ...
                        var purchaseCardExp = '<?=$purchaseCardExp?>';
                        ...
                        var activeCardPurchaseServiceRec = '<?=$activeCardPurchaseServiceRec?>';
                        ...
                        getDisplayAllCardServicesForCard(userPurchasedServices,'displayAllCardServices');
                        availableServices = '';
                    ...
                    var isWeddingUserDate = '<?=$isWeddingUserDate?>';
    ...
    function getDisplayAllCardServicesForCard(cardServicesIds,disName){
        
        var userPurchasedOrderId = '<?=$userPurchasedOrderId?>';
