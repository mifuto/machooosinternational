...
?>
 ...
 <script>
    ...
    function showCardBenfits(cardName,cardId,purchaseId,isUpdate,userEvtID,isWeddingUserDate,purchaseCardNumberVal,userPurchasedServices,userPurchasedOrderId,activeCardPurchaseServiceRec,purchaseTotalAmount='',purchaseCardExp=''){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.status == 1) {
                    ...
                    purchaseCardNumber = purchaseCardNumberVal;
