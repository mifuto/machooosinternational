...

{
    ...
    (function init($, window, document, undefined) {
        ...
        $.fn.flipBook.options = {
            ...
            deeplinkingPrefix: '',
            assets: {
                preloader: '/real3d_flipbook/src/assets/images/preloader.jpg',
                flipMp3: '/real3d_flipbook/src/assets/mp3/turnPage.mp3',
                spinner: '/real3d_flipbook/src/assets/images/spinner.gif',
                backgroundMp3: '/real3d_flipbook/src/assets/mp3/background.mp3',
            },
            pdfUrl: null,
        ...
        FLIPBOOK.Main.prototype = {
                    ...
                    if (page.items) {
                        for (let item of page.items) {
                            ...
                            switch (type) {
                                ...
                                case 'audio':
                                    page.htmlContent += `
									<audio ${loopAttribute} ${loopAttribute} ${controlsAttribute} 
            ...
            onBookCreated: function () {
                ...
                document.addEventListener('keydown', function (e) {
                    ...
                    if (!self.isFullscreen && document.body.classList.contains('flipbook-fullscreen')) {
                        return;
                    }
