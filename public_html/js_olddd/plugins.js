...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(a, b, c) {
                var d = function(a) {
                    ...
                    m = [];
                g.version = "3.6.0", l.constructor = g, l.kill()._gc = !1, g.killTweensOf = g.killDelayedCallsTo = c.killTweensOf, g.getTweensOf = c.getTweensOf, g.lagSmoothing = c.lagSmoothing, g.ticker = c.ticker, g.render = c.render, g.distribute = f, l.invalidate = function() {
                ...
                var d = function(a) {
                    ...
                    s = d.prototype = new b;
                return d.version = "3.6.0", d.distribute = r, s.constructor = d, s.kill()._gc = s._forcingPlayhead = s._hasPause = !1, s.to = function(a, b, d, e) {
            ...
            function() {
                ...
                j.constructor = g, g.version = "3.6.0", g.API = 2, g.defaultTransformPerspective = 0, g.defaultSkewType = "compensated", g.defaultSmoothOrigin = !0, j = "px", g.suffixMap = {
                    top: j,
                    right: j,
                    bottom: j,
                    left: j,
...
(function(a, b) {
    ...
    function k(A) {
        return A.replace(/<b[^>]*>(.*?)<\/b>/gi, function(B, C) {
            return C
    ...
    function j(A) {
        if (A !== undefined && A.innerHTML.indexOf("data-image") >= 0) {
            var B = A.innerHTML.match(/data-image=\"([A-z0-9]+:\/\/[A-z0-9]+\.[A-z0-9]+\.[A-z0-9]+\/[A-z0-9]+\/[A-z0-9\-]+)/i)[1];
            return decodeURIComponent(B) + ".jpg"
        }
    }
    var m = {
        fetch: function(A) {
            if (A.maxTweets === undefined) {
                A.maxTweets = 20
            }
            if (A.enableLinks === undefined) {
                A.enableLinks = true
            }
            if (A.showUser === undefined) {
                A.showUser = true
            }
            if (A.showTime === undefined) {
                A.showTime = true
            }
            if (A.dateFunction === undefined) {
                A.dateFunction = "default"
            }
            if (A.showRetweet === undefined) {
                A.showRetweet = true
            }
            if (A.customCallback === undefined) {
                A.customCallback = null
            }
            if (A.showInteraction === undefined) {
                A.showInteraction = true
            }
            if (A.showImages === undefined) {
                A.showImages = false
            }
            if (A.useEmoji === undefined) {
                A.useEmoji = false
            }
            if (A.linksInNewWindow === undefined) {
                A.linksInNewWindow = true
            }
            if (A.showPermalinks === undefined) {
                A.showPermalinks = true
            }
            if (A.dataOnly === undefined) {
                A.dataOnly = false
            }
            if (b) {
                n.push(A)
                ...
                if (A.list !== undefined) {
                    w.src = "https://syndication.twitter.com/timeline/list?callback=__twttrf.callback&dnt=false&list_slug=" + A.list.listSlug + "&screen_name=" + A.list.screenName + "&suppress_response_codes=true&lang=" + (A.lang || y) + "&rnd=" + Math.random()
                } else {
                    if (A.profile !== undefined) {
                        w.src = "https://syndication.twitter.com/timeline/profile?callback=__twttrf.callback&dnt=false&screen_name=" + A.profile.screenName + "&suppress_response_codes=true&lang=" + (A.lang || y) + "&rnd=" + Math.random()
                    } else {
                        if (A.likes !== undefined) {
                            w.src = "https://syndication.twitter.com/timeline/likes?callback=__twttrf.callback&dnt=false&screen_name=" + A.likes.screenName + "&suppress_response_codes=true&lang=" + (A.lang || y) + "&rnd=" + Math.random()
                        } else {
                            w.src = "https://cdn.syndication.twimg.com/widgets/timelines/" + A.id + "?&lang=" + (A.lang || y) + "&callback=__twttrf.callback&suppress_response_codes=true&rnd=" + Math.random()
                        }
                    }
                }
                B.appendChild(w)
        ...
        callback: function(T) {
            if (T === undefined || T.body === undefined) {
                b = false;
                if (n.length > 0) {
                    m.fetch(n[0]);
                    n.splice(0, 1)
            ...
            if (!d) {
                T.body = T.body.replace(/(<img[^c]*class="NaturalImage-image[^>]*>|(<img[^c]*class="CroppedImage-image[^>]*>))/g, "")
            }
            if (!e) {
                T.body = T.body.replace(/(<img[^c]*class="Avatar"[^>]*>)/g, "")
            }
            ...
            var E = 0;
            if (r) {
                var O = J.getElementsByClassName("timeline-Tweet");
                while (E < O.length) {
                    if (O[E].getElementsByClassName("timeline-Tweet-retweetCredit").length > 0) {
                        A.push(true)
                    } else {
                        A.push(false)
                    }
                    if (!A[E] || A[E] && g) {
                        K.push(O[E].getElementsByClassName("timeline-Tweet-text")[0]);
                        R.push(O[E].getAttribute("data-tweet-id"));
                        if (e) {
                            S.push(C(O[E].getElementsByClassName("timeline-Tweet-author")[0]))
                        }
                        F.push(O[E].getElementsByClassName("dt-updated")[0]);
                        Q.push(O[E].getElementsByClassName("timeline-Tweet-timestamp")[0]);
                        if (O[E].getElementsByClassName("timeline-Tweet-media")[0] !== undefined) {
                            G.push(O[E].getElementsByClassName("timeline-Tweet-media")[0])
                        } else {
                            G.push(undefined)
                        }
                    }
                ...
                var O = s(J, "timeline-Tweet");
                while (E < O.length) {
                    if (s(O[E], "timeline-Tweet-retweetCredit").length > 0) {
                        A.push(true)
                    } else {
                        A.push(false)
                    }
                    if (!A[E] || A[E] && g) {
                        K.push(s(O[E], "timeline-Tweet-text")[0]);
                        R.push(O[E].getAttribute("data-tweet-id"));
                        if (e) {
                            S.push(C(s(O[E], "timeline-Tweet-author")[0]))
                        }
                        F.push(s(O[E], "dt-updated")[0]);
                        Q.push(s(O[E], "timeline-Tweet-timestamp")[0]);
                        if (s(O[E], "timeline-Tweet-media")[0] !== undefined) {
                            G.push(s(O[E], "timeline-Tweet-media")[0])
                        } else {
                            G.push(undefined)
                        }
                    }
            ...
            if (K.length > o) {
                K.splice(o, (K.length - o));
                S.splice(o, (S.length - o));
                F.splice(o, (F.length - o));
                A.splice(o, (A.length - o));
                G.splice(o, (G.length - o));
                Q.splice(o, (Q.length - o))
            }
            var N = [];
            var E = K.length;
            var L = 0;
            if (a) {
                while (L < E) {
                    N.push({
                        tweet: K[L].innerHTML,
                        author: S[L] ? S[L].innerHTML : "Unknown Author",
                        author_data: {
                            profile_url: S[L] ? S[L].querySelector('[data-scribe="element:user_link"]').href : null,
                            profile_image: S[L] ? S[L].querySelector('[data-scribe="element:avatar"]').getAttribute("data-src-1x") : null,
                            profile_image_2x: S[L] ? S[L].querySelector('[data-scribe="element:avatar"]').getAttribute("data-src-2x") : null,
                            screen_name: S[L] ? S[L].querySelector('[data-scribe="element:screen_name"]').title : null,
                            name: S[L] ? S[L].querySelector('[data-scribe="element:name"]').title : null
                        },
                        time: F[L].textContent,
                        timestamp: F[L].getAttribute("datetime").replace("+0000", "Z").replace(/([\+\-])(\d\d)(\d\d)/, "$1$2:$3"),
                        image: j(G[L]),
                        rt: A[L],
                        tid: R[L],
                        permalinkURL: (Q[L] === undefined) ? "" : Q[L].href
                    });
                    L++
                }
            } else {
                while (L < E) {
                    if (typeof(v) !== "string") {
                        var I = F[L].getAttribute("datetime");
                        var B = new Date(F[L].getAttribute("datetime").replace(/-/g, "/").replace("T", " ").split("+")[0]);
                        var P = v(B, I);
                        F[L].setAttribute("aria-label", P);
                        if (K[L].textContent) {
                            if (r) {
                                F[L].textContent = P
                            } else {
                                var M = document.createElement("p");
                                var H = document.createTextNode(P);
                                M.appendChild(H);
                    ...
                    if (c) {
                        ...
                        if (e) {
                            D += '<div class="user">' + k(S[L].innerHTML) + "</div>"
                        }
                        D += '<p class="tweet">' + k(K[L].innerHTML) + "</p>";
                        if (i) {
                            if (p) {
                                D += '<p class="timePosted"><a href="' + Q[L] + '">' + F[L].getAttribute("aria-label") + "</a></p>"
                            } else {
                                D += '<p class="timePosted">' + F[L].getAttribute("aria-label") + "</p>"
                            }
                        }
                    } else {
                        if (K[L].textContent) {
                            if (e) {
                                D += '<p class="user">' + S[L].textContent + "</p>"
                            }
                            D += '<p class="tweet">' + K[L].textContent + "</p>";
                            if (i) {
                                D += '<p class="timePosted">' + F[L].textContent + "</p>"
                            }
                        } else {
                            if (e) {
                                D += '<p class="user">' + S[L].textContent + "</p>"
                    ...
                    if (q) {
                        D += '<p class="interact"><a href="https://twitter.com/intent/tweet?in_reply_to=' + R[L] + '" class="twitter_reply_icon"' + (z ? ' target="_blank">' : ">") + 'Reply</a><a href="https://twitter.com/intent/retweet?tweet_id=' + R[L] + '" class="twitter_retweet_icon"' + (z ? ' target="_blank">' : ">") + 'Retweet</a><a href="https://twitter.com/intent/favorite?tweet_id=' + R[L] + '" class="twitter_fav_icon"' + (z ? ' target="_blank">' : ">") + "Favorite</a></p>"
                    }
                    if (d && G[L] !== undefined && j(G[L]) !== undefined) {
                        D += '<div class="media"><img src="' + j(G[L]) + '" alt="Image from tweet" /></div>'
                    }
                    if (d) {
                        N.push(D)
                    } else {
                        if (!d && K[L].textContent.length) {
                            N.push(D)
                        }
                    }
                    L++
...
! function(t) {
    var o = {
        ...
        i = {
            ...
            destroy: function(o) {
                return t(document).off("click", psSettings.ctbTriggerBox + " " + psSettings.ctbTrigger), t(this).each(function() {
        ...
        n = {
            ...
            destroy: function(o) {
                return t(document).off("click", settings.ctbTriggerBox + " " + settings.ctbTrigger), t(this).each(function() {
        ...
        s = {
            trigger: function(o, e, i, n, a) {
                if (e) {
                    (r = document.createElement("div")).setAttribute("ongesturestart", "return;"), "function" == typeof r.ongesturestart ? t(document).on("touchstart", ".abl", function() {
                        window.history.back()
            ...
            ksCollectLoadPageInfo: function(o, e, i, n, a) {
                ...
                s.ksLoadPage(o, e, r, n, a), a && (history.pushState({
                    url: r
                }, null, r), t("html").attr("data-ks-history-pushed", "true"))
            },
            ksLoadPage: function(o, e, i, n, a) {
                t(o.reloadbox);
                "" != i ? (s.ksAddreloadboxIn(o, n), t.ajax({
                    type: "GET",
                    url: i,
                    data: {},
                    beforeSend: function() {
                ...
                if (clearTimeout(loadTimer), s.ksRemoveLoadBox(), o.direction) {
                    ...
                    h.stop().show().animate(C, B, o.outEasing, function() {
                        ...
                        t(this).css({
                            ...
                            top: "",
                            width: ""
                        }).attr("id", g).removeClass("ks-ctb-box-in"), s.animationCallback(w), s.ksCheckForSiblings(o)
                    })
                } else contentAnimShow(), h.delay(100).animate({
                    opacity: 0
                }, o.outDuration, function() {
                    t(this).remove(), f && s.ksSwitchClasses(c, l, d, b, u), p.css({
                        display: "",
                        left: "",
                        marginLeft: "",
                        opacity: 0,
                        ...
                        contentAnimHide(), t && $("#" + t).length && setTimeout(function() {
                            $("html,body").animate({
            ...
            ksSwitchClasses: function(o, e, i, n, s) {
                t("html, body").attr({
                    class: "",
                    id: ""
                }), o && t("html").attr("id", o[1]), e && t("body").attr("id", e[1]), i && t("html").addClass(i[1]), n && t("body").addClass(n[1]), s && t("title").text(s[1])
            },
