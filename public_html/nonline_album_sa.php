                                    ...
                                    <div class="row " >
                                       ...
                                       <div class="col-md-9 col-sm-12" >
                                          ...
                                          <div class="row">
                                             ...
                                             <a href="#" id="lightBoxpdf" style="margin-top: 10px !important;" class="single-btn fl-wrap "><span>View Album</span></a>
...
<?php 
   ...
   <script src="/pdftoimageconverter/ssource/js/textLayerBuilder.js"></script>
	<script src="/pdftoimageconverter/ssource/js/mainN.js"></script>
...
// 		progressMessage.textContent = 'Fetching your online album...';
...
//         }else $("#albumViewList").removeClass('d-none');
   ...
   function generateBook(){
        ...
        //     var title = 'Image ' + (index + 1); // You can customize the title as needed
