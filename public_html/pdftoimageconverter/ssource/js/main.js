	...
	async function convertFromUrl(pdfUrl) {
		...
		try {
            ...
            while (true) {
            	...
            	progressMessage.textContent = 'Loading your portable photo book...'+progress+'%';
...
// 			handleFileUpload(file);
	...
	async function handleFileUpload(file) {
		...
		reader.onloadstart = function () {
			...
			progressMessage.textContent = 'Preparing your portable photo book...';
...
// 			progressBar.style.width = '100%';
    ...
    async function renderPageChunk(pdf, folder, folderName, startPage, endPage, zip, file, numPages) {
        ...
        // 		console.log(chunkCounter+" "+currentPage+" "+perPercentage);
            ...
            progressMessage.textContent = 'Preparing your portable photo book...' + perPercentage + '%';
        }
	...
	async function renderPage(pdf, page, folder, folderName, currentPage, numPages, zip, file ,chunkSize ) {
	   // console.log(chunkSize);
		...
		progressMessage.textContent = 'Preparing your portable photo book...' + Math.round(((currentPage / numPages) * 100)) + '%';
...
// 				// progressBar.style.width = progress + '%';
// 				progressMessage.textContent = 'Preparing your portable photo book...100%';
// 			});
