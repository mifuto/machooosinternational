                        ...
                        <div class="clearfix"></div>
                         ...
                         <div style="padding-top: 0px;">
                            <div >
                                ...
                                <div class="d-none" id="userProjectListDivData" style="padding-top:20px;">
                                            ...
                                            <?php
                                                foreach ($albums as $key => $album) { 
                                        			...
                                        			$imageCount = $album['imageCount'];
                                                        ...
                                                        if($imageCount > 4999) $sql3 = "SELECT * FROM `tblalbumsubscription` WHERE `period`=1 AND photo_count='Unlimited' AND `signature`=1 AND `delete`=0  ";
                                                        else if($imageCount > 2999) $sql3 = "SELECT * FROM `tblalbumsubscription` WHERE `period`=1 AND photo_count=4999 AND `signature`=1 AND `delete`=0  ";
                                                        else if($imageCount > 1499) $sql3 = "SELECT * FROM `tblalbumsubscription` WHERE `period`=1 AND photo_count=2999 AND `signature`=1 AND `delete`=0  ";
                                                        else $sql3 = "SELECT * FROM `tblalbumsubscription` WHERE `period`=1 AND photo_count=1499 AND `signature`=1 AND `delete`=0  ";
                                                ...
                                                <div class="gallery-item  " style="padding:10px;">
                                                           <div class="grid-item-holder ">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="d-flex justify-content-start" style="padding-top:5px;">
                                                                       <span class="mr-3" ><i class="far fa-eye"></i> <?=$album['viewCounts']?></span>
                                                                        ...
                                                                        <span class="mr-3" style="padding-left:10px;"><i class="far fa-comment"></i> <?=$album['commentCount']?></span>
                                                            ...
                                                            <div class="row" style="padding-left:5px;padding-right:5px;">
                                                                ...
                                                                <!--        <h3 class="img-heading" style="padding-top:10px;"><?=$album['project_name']?></h3>-->
                                                                <!--    </div>-->
                                                                <!--</div>-->
                                                                ...
                                                                <div class="row" style="padding-left:5px;padding-right:5px;">
                                                                 ...
                                                                 <input type="hidden" id="imageCount_<?=$id?>" value="<?=$imageCount?>" >
                                                                ...
                                                                <?php if($album['cartCount'] <= 0 ){ ?>
                                                                    ...
                                                                    <div class="row" style="padding-left:5px;padding-right:5px;">
                                                                        <div class="col-12">
                                                                            <div class="d-flex justify-content-center" style="padding-top:5px;">
                                                                                <div class="card voutchers" onclick="addCart(<?=$album['id']?>,'SA',<?=$id?>,<?=$imageCount?>);">
                                ...
                                <!-- <div class="" id="userProjectListDiv" style="padding-top:10px;">-->
                                ...
                                <!--<div class="row " id="userProjectListDiv" style="padding-top:20px;">-->
                                ...
                                <div class="row fl-wrap" id="signatureAlbumTabContent"></div>
                                ...
                                <?php if(count($OLalbums) > 0) { ?>
                                    ...
                                    <div class="row" style="padding-bottom:30px;"> <hr>
...
<!-- 
                                        <div style="width: 30rem; margin: auto;">
                                            <div style="padding-bottom: 20px;">
                                                <h2 class="card-title" style="font-size: 22px; margin-top: 20px;">Hope you liked it.</h2>
                                                <div style="margin-top: 20px;">
                                                    <img src="images/machooseLogo.png" alt="" style="width: 68px;">
                                                </div>
                                                <a href="javascript:void(0);" onclick="showEnquiryform();" class="single-btn fl-wrap" style="margin-top: 30px"><span>Talk to us</span></a>
                                            </div>
                                        </div> -->
                                </div>
