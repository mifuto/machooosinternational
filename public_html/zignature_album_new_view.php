...
$signatureAlbymGetSql = "SELECT *,(SELECT COUNT(*) FROM signature_album_like
    WHERE project_id = tbesignaturealbum_projects.id AND status=1 AND active=0 ) AS likeCounts FROM tbesignaturealbum_projects WHERE id='$projId' ";
                                                                    ...
                                                                    <li class="list-inline-item g-mr-20" style="margin-right: 0rem !important;" id="disLikeButton">
                                                                        ...
                                                                        <?php if($isDisComment){ ?>
                                                                         ...
                                                                         <? if( $like_status ){ ?>
                                                                            ...
                                                                            <a class="btn position-relative" href="#" onclick="dislikeSignaturealbum()" style="border-color: transparent;white-space: nowrap;">
                                                                         ...
                                                                         <?php }else{ ?>
                                                                            ...
                                                                            <a class="btn position-relative" href="#" onclick="likeSignaturealbum()" style="border-color: transparent;white-space: nowrap;">
                                                                        ...
                                                                        <?php }else{ ?>
                                                                            ...
                                                                            <a class="btn position-relative" href="#" onclick="showGuestUserModal()" style="border-color: transparent;white-space: nowrap;">
