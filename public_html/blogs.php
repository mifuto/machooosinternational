            ...
            <div class="row">
                ...
                <? } else { ?>
                     ...
                     <div class="col-md-12 " style="padding: 40px;text-align: center;" id="errExpiry">
                        ...
                        <span class="bold-text text-danger new-text-sub-fond-1"><b style="letter-spacing: .05rem;">No news available!</b></span> 
...
$( document ).ready(function() {
 ...
 function getAllBlogsRecs(selStart,selStop){
         successFn = function(resp)  {
            if(resp.status == 1){
                ...
                for(var i=0;i<len;i++){
                    ...
                    var date = new Date(eventLists[i]['posted_date']);
        			...
        			var originalWord = eventLists[i]['tittle'];
                    var maxLength = 30;
                    ...
                    if(eventLists[i]['video'] != ""){
                        ...
                        if(trimmedString == 'blogImages') var video_upload = 'admin/'+eventLists[i]['video'];
                   ...
                   htmlC += '';
                    ...
                    htmlC += '<div class="row " >';
                     ...
                     htmlC += '<img style="width: 100%;" src="admin/'+eventLists[i]['image']+'" alt="">';
                     htmlC += '</div>';
                     htmlC += '</div>';
                      htmlC += '</div>';
                       htmlC += '</div>';
                    ...
                    htmlC += '<h4  style="color:#757373;text-align: left;margin-bottom: 0.3rem !important;font-size: 0.7em !important;">'+eventLists[i]['firstname']+' '+eventLists[i]['lastname']+'</h4>';
                ...
                $('#listAllBlogs').html(htmlC);
                fristfetchRec = false;
                
            }
         }
        data = { "function": 'Blogs',"method": "getAllBlogsRecs",'selStart':selStart,'selStop':selStop ,'user_state_val':'<?=$user_state_val?>'  };
     ...
     function handleIframeClick(id) {
            ...
            successFn = function(resp)  {
                if(resp.status == 1){
                     ...
                     if(eventList['video'] != ""){
                        ...
                        var trimmedString = eventList['video'].substring(0, 10);
                    
                        if(trimmedString == 'blogImages') var video_upload = 'admin/'+eventList['video'];
                        else  var video_upload = eventList['video'];
                        
                    }
                 
                    
                    var date = new Date(eventList['posted_date']);
                    ...
                    if(eventList['video'] != ""){
                         ...
                         var vedHtml = '<div class="col-md-12 col-sm-12"><div class="image-container justify-content-center align-items-center" style="width: 100%; overflow: hidden;"><img style="width: 100%;" src="admin/'+eventList['image']+'" alt=""></div> </div>';
                    }
                    ...
                    vedHtml +='<div class="col-12" style="text-align: left;"><h4 style="color:#757373;text-align: left;margin-bottom: 0.3rem !important;font-size: 0.7em !important;">Author: '+eventList['firstname']+' '+eventList['lastname']+',  Published on '+dt+' </h4></div>';
                    ...
                    vedHtml +='<div class="col-6" style="text-align: right;padding-top:0px;"><span class="bold-text new-text-sub-fond-1 mobile-disply-none" style="padding-left: 0px !important;">Share : </span><button onclick="addBlgShareCount('+id+',`'+eventList['tittle']+'`)" type="button" id="share-fb" xmlns="http://www.w3.org/2000/svg"  class="btn position-relative" data-mdb-ripple-unbound="true" style="padding-right: 0px !important;"> <i class="fab fa-facebook-f fa-1x" style="color: #3b5998;"></i> </button>  <button type="button" onclick="addBlgShareCount('+id+',`'+eventList['tittle']+'`)" id="share-tw" class="btn position-relative" data-mdb-ripple-unbound="true" style="padding-right: 0px !important;"> <i class="fab fa-twitter fa-1x" style="color: #55acee;"></i>    </button>   <button type="button" onclick="addBlgShareCount('+id+',`'+eventList['tittle']+'`)" id="share-em" class="btn position-relative" data-mdb-ripple-unbound="true" style="padding-right: 0px !important;"> <i class="fab fa-google fa-1x" style="color: #dd4b39;"></i>   </button>    <button type="button" onclick="addBlgShareCount('+id+',`'+eventList['tittle']+'`)" id="share-wh" class="btn position-relative" data-mdb-ripple-unbound="true" style="padding-right: 0px !important;">    <i class="fab fa-whatsapp fa-1x" style="color: #25d366;"></i>  </button> <button type="button" class="btn position-relative" onclick="copyFilmUrl('+id+');addBlgShareCount('+id+',`'+eventList['tittle']+'`)" style="padding-right: 0px !important;">  <i class="fa fa-link fa-1x" style="color: #7e7e7e;"></i> </button></div> </div>  </div>';
                    
                    
                     var originalString = eventList['long_description'];
                  ...
                  vedHtml +='<div class="row" id="dispayImg"><div class="col-12" style="text-align: left;padding-left: 15px;padding-right: 15px;"><div>'+newString+' </div></div></div>';
            ...
            data = { "function": 'Blogs',"method": "getBlogsRec" ,"id":id,"user_type_val" : user_type_val , "user_id_like" : user_id_like ,'projId_id_like':id };
         ...
         function likeAlbum(statusV){
            ...
            data = { "function": 'Blogs',"method": "likeBlogs", "user_type_val" : user_type_val , "user_id_like" : user_id_like , 'status':statusV ,'projId_id_like':projId_id_like};
         ...
         function addBlgShareCount(id,name){
         
            successFn = function(resp)  {
            }
            data = { "function": 'Blogs',"method": "addShare" ,"projId":id,"name":name};
            apiCall(data,successFn);
...
$(function() {
    ...
    function cb(start, end) {
       ...
       if(fristfetchRec) return false;
        getAllBlogsRecs(selStart,selStop);
