                        ...
                        <div class="post_header fl-wrap">
                            <div class="container-fluid" style="max-width: 100%; padding: 0px; width: 100%;">
                                ...
                                <div class="row" style="margin-right:0px; padding: 0px;">
                                    ...
                                    <!--    <img id="eventCoverImage" src="admin/<?= EVENT_UPLOAD_PATH. $selAlbums[0]['uploader_folder'].'/'.$selAlbums[0]['covering_name'] ?>" class="full-width-height-image">-->
                                    
                                    <!--    <div class="sa-list-img-d1">-->
                                    <!--        <h1 class="text-white new-text-sub-fond sa-list-img-d2" ><?=$selAlbums[0]['event_name']?></h1>-->
                                    ...
                                    <!--                <span class="bold-text new-text-sub-fond-1" style="letter-spacing: 1px !important;">View Album</span>-->
                                    <!--            </a>-->
                                    <!--        </div>-->
                                                                        ...
                                                                        <?php if(count($albums) > 0) {
                                                                                        foreach ($albums as $key => $album) { ?>
                                                                                          ...
                                                                                          <div class="col-md-3 col-sm-12">
                                                                                                <img  src="admin/<?= EVENT_UPLOAD_PATH . $album['uploader_folder'] . '/' . $album['covering_name'] ?>" alt="" width="100%">
                                                                                            </div>
                                                                                                       ...
                                                                                                       <div class="col-12" style="text-align: left;">
                                                                                                        ...
                                                                                                        <div class="col-12" style="text-align: left;">
                                                                                                         ...
                                                                                                         <div class="col-12" style="text-align: left;">
                                                                                                            ...
                                                                                                            <a href="#" id="show_book_<?= $album['album_id'] ?>" style="margin-top: 10px !important;" class="single-btn fl-wrap"><span>View Album</span></a>
        ...
        <?php foreach ($albums as $key => $album) { ?>
            ...
            var bookOptions_<?= $album['album_id'] ?> = {
                ...
                ,onShowPage: function(book, page, pageIndex) {
                    ...
                    $(".wowbook-controls a").prop("href", "javascript:void(0);");
                }
